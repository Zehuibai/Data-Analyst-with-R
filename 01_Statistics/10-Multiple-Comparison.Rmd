---
title: 'As-a-Statistician-Multiple-Comparison'
author: "Zehui Bai"
...
knitr::include_graphics("./02_Plots/Schweder-Spjøtvoll 1.png")
```
...
knitr::include_graphics("./02_Plots/Schweder-Spjøtvoll 2.png")
```
...
knitr::include_graphics("./02_Plots/Schweder-Spjøtvoll 3.png")
```
...
knitr::include_graphics("./02_Plots/Turkey_Diffgram.png")
```
...
knitr::include_graphics("./02_Plots/Turkey_Plots.png")
```
...
knitr::include_graphics("./02_Plots/Turkey_Boxplots.png")
```
...
knitr::include_graphics("./02_Plots/Dunnett_OneSide.png")
```
...
knitr::include_graphics("./02_Plots/ACNOVA_Effect.png")
```
...
knitr::include_graphics("./02_Plots/discrete_approximation.png")
```
...
knitr::include_graphics("./02_Plots/Close_Begin.PNG")
```
...
knitr::include_graphics("./02_Plots/Sequential_testing.png")
```
...
knitr::include_graphics("./02_Plots/Sequential_Gatekeeping_testing.png")
```
...
knitr::include_graphics("./02_Plots/all_pairwise_comparisons.png")
```
...
knitr::include_graphics("./02_Plots/Dunnett_Close_Test.png")
```
