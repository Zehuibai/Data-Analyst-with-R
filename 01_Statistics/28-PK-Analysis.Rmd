---
title: 'As-a-Statistician-PK and PD Analysis'
author: "Zehui Bai"
...
knitr::include_graphics("./02_Plots/PK01.png")
```
...
knitr::include_graphics("./02_Plots/PK02.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK03.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK04.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK05.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK06.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK07.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK08.png")
```

In summary, Pertinent kinetic estimates after extravascular dosing are listed

```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK09.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK10.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK11.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK12.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK13.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK14.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK15.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK16.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK17.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PD08.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PD09.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PD10.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PK18.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PD01.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PD02.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PD03.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PD04.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PD05.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PD06.png")
```
...
```{r  , echo=FALSE, fig.align="center", out.width = '100%'}
knitr::include_graphics("./02_Plots/PD07.png")
```
...
## PK and PD data transfer

Providing the Analysis Data Model (ADaM) CDISC compliant datasets for PK and PD (e.g. ADPP and ADPC) 
...
mySpecc_adpp %>% 
  kable(caption = "PK Analysis Dataset", format = "html") %>%
...
mySpecc_adpc %>% 
  kable(caption = "PD Analysis Dataset", format = "html") %>%
  kable_styling(latex_options = "striped")
```
...
library(sas7bdat)
library(clinUtils)
SAS_adpc <- read.sas7bdat("01_Datasets/adpc.sas7bdat")
getClinDT(SAS_adpc)
```
